  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        ...
        // Handle error state here, e.g., setError(error.message)
      }
    };
      ...
      >
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button
            ...
            className="p-3 bg-slate-700 text-white uppercase rounded-lg my-3 hover:opacity-95 disabled:opacity-80"
          >
